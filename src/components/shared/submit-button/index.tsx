...
const SubmitButton: React.FC<ButtonTextProps> = ({
  ...
  return (
    <button
      className={`py-3 px-5 text-sm font-medium w-full text-center text-white rounded-lg bg-blue-700 focus:ring-4 focus:outline-none focus:ring-primary-300 hover:opacity-90 flex justify-center items-center gap-2 ${
