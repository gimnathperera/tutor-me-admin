...
//     subjectsData?.results?.map((s: any) => ({ value: s.id, label: s.title })) ||
//     [];
//   const levelOptions =
//     levelsData?.results?.map((l: any) => ({ value: l.id, label: l.title })) ||
//     [];
//   const gradeOptions =
//     gradesData?.results?.map((g: any) => ({ value: g.id, label: g.title })) ||
//     [];
...
//             <Input
//               {...register("fullTimeTuitionRate.0.minimumRate")}
//               placeholder="Minimum Rate"
//             />
//             <Input
//               {...register("fullTimeTuitionRate.0.maximumRate")}
...
//             <Input
//               {...register("govTuitionRate.0.minimumRate")}
//               placeholder="Minimum Rate"
//             />
//             <Input
//               {...register("govTuitionRate.0.maximumRate")}
//               placeholder="Maximum Rate"
//             />
//           </div>
...
//             <Input
//               {...register("partTimeTuitionRate.0.minimumRate")}
//               placeholder="Minimum Rate"
//             />
//             <Input
//               {...register("partTimeTuitionRate.0.maximumRate")}
//               placeholder="Maximum Rate"
//             />
//           </div>
